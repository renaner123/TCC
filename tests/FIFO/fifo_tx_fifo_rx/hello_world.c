...
int main()
{
	...
	for(i=0;i<100;i++){
		  ...
		  altera_avalon_fifo_write_fifo(FIFO_TX_IN_BASE,FIFO_TX_IN_CSR_BASE,i);
		  ...
		  //altera_avalon_fifo_clear_event(FIFO_0_OUT_BASE,FIFO_0_IN_CSR_BASE);
		  //altera_avalon_fifo_write_other_info(FIFO_0_OUT_BASE,FIFO_0_IN_CSR_BASE,0x01);
